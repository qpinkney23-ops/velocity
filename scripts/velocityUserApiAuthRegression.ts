...
const approvedMigratedRoutes = ["applications/[id]/route.ts", "applications/[id]/analyze/route.ts", "applications/[id]/documents/route.ts", "applications/[id]/report/route.ts", "applications/[id]/documents/[documentId]/route.ts"] as const;
