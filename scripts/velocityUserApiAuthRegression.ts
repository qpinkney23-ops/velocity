...
const approvedMigratedRoutes = ["applications/route.ts", "applications/[id]/route.ts", "applications/[id]/analyze/route.ts", "applications/[id]/decision/route.ts", "applications/[id]/documents/route.ts", "applications/[id]/report/route.ts", "applications/[id]/workflow/route.ts", "applications/[id]/documents/[documentId]/route.ts", "stripe/checkout/route.ts", "stripe/portal/route.ts"] as const;
